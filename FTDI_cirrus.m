...
%ati' nin malidir.......
% Last Modified by GUIDE v2.5 01-Oct-2013 15:43:01
%%
gui_Singleton = 1;
...
set(handles.radiobutton8,'Value',0);set(handles.radiobutton8,'Enable','off');%Read simdilik HEX yapamasin artik
...
num_tx=uint32(0);
                 Sending_Data_Array_uint8 = uint8(get(handles.edit1,'String'));
                                   %Sending_Data_Array_uint8=uint8([129]);
...
% cevriliyor.          
                                  ...
                                  if ((status_Tx_Available==handles.FT_OK)&&(TxQueue==0))
                                              ...
                                              Tx_New_length_int32=int32(length(Sending_Data_Array_uint8));%burasi
                                              [status_Write,num_tx]=Write(handles.PortOBJ,Sending_Data_Array_uint8,Tx_New_length_int32,num_tx);
                                   end
...
elseif 1==get(handles.radiobutton21,'UserData')
        ...
        Sending_Cirrus_Data_Array_uint8= uint8([Sending_Cirrus_Data_Array_uint8 0]);
end
